export function PageThemeButton(){
    ...
    const changeLocalTheme= () =>{
        const themeUp = localStorage.getItem("theme");
        if(themeUp === "dark") {
    ...
    return(
        <button id="theme_mode" onClick={userClick} className="theme_button" aria-label="Muda o tema da pagina para escuro ou claro" title="Muda o tema da pagina para escuro ou claro">
